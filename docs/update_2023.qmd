...
date: last-modified
date-format: "[Updated on] MMMM, YYYY"
format: 
  html:
      toc: TRUE
...
st_write(out,"wfsvi_2023.shp",append=FALSE,quiet = TRUE)
...
You can download the spatial data in several formats here:
