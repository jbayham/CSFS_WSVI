...
st_write(out,"wfsvi_2023.gpkg",append=FALSE)
...
You can download the spatial data [here](wfsvi_2023.gpkg) and a spreadsheet version of the data [here](wfsvi_2023.csv)
