...
map<-leaflet(SVI_layer)%>%
  ...
  addPolygons(color = "#444444",weight = 1, smoothFactor = 0.5,
   ...
   popup = paste("Rank", round(SVI_layer$overall_rank_wui,digits=2), "<br>",
                 "Percent of individuals below the poverty line",SVI_layer$poverty_percent_below_1, "<br>",
                 "Percent of the Civilian labor force which is unemployed",SVI_layer$civ_labor_force_unemployed_percent_2,"<br>",
                 "Median household income",SVI_layer$median_hh_income_3,"<br>",
                 "Percent of adults over 25 without a High School Diploma",SVI_layer$no_hs_degree_percent_4,"<br>",
                 "Percent of people over the age of 65",SVI_layer$over_65_percent_5,"<br>",
                 "Percent of people under the age of 18",SVI_layer$under_18_percent_6,"<br>",
                 "Percent of the population above 18 with a disability",SVI_layer$isabled_adult_percent_7,"<br>",
                 "Percent Single Parent HH",SVI_layer$single_householder_percent_8,"<br>",
                 "Percent of the population that are of minority status",SVI_layer$percent_minority_9,"<br>",
                 "Percent of the population that speak English < well",SVI_layer$do_not_speak_english_well_percent_10,"<br>",
                 "Percent of housing structures that have 10 or more units",SVI_layer$units_over_10_percent_11,"<br>",
                 "Percent of housing units that are mobile homes",SVI_layer$units_mobile_percent_12,"<br>",
                 "Percent of households with more people than rooms",SVI_layer$over_1_person_room_percent_13,"<br>",
                 "Percent of households with no vehicle",SVI_layer$no_vehicle_percent_14,"<br>",
                 "Percent of people who live in group housing",SVI_layer$roup_quarters_percent_15,"<br>",
                 "Income GINI",SVI_layer$gini_income,"<br>",
                 "Education GINI",SVI_layer$gini_education),
