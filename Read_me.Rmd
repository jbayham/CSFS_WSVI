...
map<-leaflet(SVI_layer)%>%
  ...
  addPolygons(color = "#444444",weight = 1, smoothFactor = 0.5,
    ...
    opacity=.6)%>%
  addLayersControl(
    overlayGroups = c("Augmented SVI","Augmented SVI WUI","WUI flip","WUI flip crowd","WUI"),
    options = layersControlOptions(collapsed = FALSE))%>%
      hideGroup(c("Augmented SVI","Augmented SVI WUI","WUI flip","WUI flip crowd","WUI"))
